                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                                ...
                                <div class="bg-gray-900/50 rounded p-3 border border-gray-700">
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        @if($canManage)
                                            <a href="{{ route('characters.conditions.create', $character) }}" class="text-blue-400 hover:text-blue-300 text-xs text-white">Add</a>
                                        @endif
                                    </div>
                                                ...
                                                <div class="flex justify-between items-center bg-gray-800 rounded px-2 py-1">
                                                    ...
                                                    @if($canManage)
                                                        <form action="{{ route('characters.conditions.destroy', [$character, $condition]) }}" method="POST" class="inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="text-red-400 hover:text-red-300 text-xs text-white">×</button>
                                                        </form>
                                                    @endif
                                                </div>
                                            @endforeach
                                ...
                                <div class="bg-gray-900/50 rounded p-3 border border-gray-700">
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        @if($canManage)
                                            <a href="{{ route('characters.state-effects.create', $character) }}" class="text-blue-400 hover:text-blue-300 text-xs text-white">Add</a>
                                        @endif
                                    </div>
                                ...
                                <div class="bg-gray-900/50 rounded p-3 border border-gray-700">
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        @if($canManage)
                                            <a href="{{ route('characters.reactions.create', $character) }}" class="text-blue-400 hover:text-blue-300 text-xs text-white">Add</a>
                                        @endif
                                    </div>
