                                                                ...
                                                                <div class="flex gap-1 ml-2" x-data="{ damageModal: false }">
                                                                    ...
                                                                    <div x-show="damageModal" 
                                                                        ...
                                                                        <div @click.away="damageModal = false" 
                                                                            ...
                                                                            <h3 class="text-xl font-bold mb-4">Apply Damage to {{ $character->name }}</h3>
                                                                            
                                                                            <form action="{{ route('combats.characters.update-hp', [$combat, $character]) }}" method="POST">
                                                                                @csrf
                                                                                ...
                                                                                <button type="button" @click="addEntry()" 
                                                                                    class="text-sm text-blue-400 hover:text-blue-300 mb-4">+ Add Damage Type</button>
                                                                                
                                                                                <div class="flex items-center mb-6">
                                                                                    <input type="checkbox" name="ignore_resist" id="ignore_resist_{{ $character->id }}" 
                                                                                        x-model="ignoreResist" value="1"
                                                                                        class="w-4 h-4 text-red-600 bg-gray-700 border-gray-600 rounded focus:ring-red-500">
                                                                                    <label :for="'ignore_resist_{{ $character->id }}'" class="ml-2 text-sm">Ignore Resistance (Elemental Adept)</label>
                                                                                </div>
                                                                                ...
                                                                                <div class="flex justify-end gap-3">
                                                                                    ...
                                                                                    <button type="submit" 
                                                                                        class="px-4 py-2 bg-red-600 hover:bg-red-700 rounded text-white font-bold">Apply Damage</button>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                @if($character->resistances && count($character->resistances) > 0)
                                                                    <div class="flex items-center gap-1">
                                                                        ...
                                                                        @foreach($character->resistances as $res)
                                                                            <span class="px-1.5 py-0.5 bg-blue-900/30 text-blue-300 rounded text-[10px] border border-blue-800/50">
                                                                                {{ ucfirst($res) }}
                                                                            </span>
                                                                        @endforeach
                                                                    </div>
                                                                ...
                                                                @if($character->immunities && count($character->immunities) > 0)
                                                                    <div class="flex items-center gap-1">
                                                                        ...
                                                                        @foreach($character->immunities as $imm)
                                                                            <span class="px-1.5 py-0.5 bg-green-900/30 text-green-300 rounded text-[10px] border border-green-800/50">
                                                                                {{ ucfirst($imm) }}
                                                                            </span>
                                                                        @endforeach
                                                                    </div>
                                                                ...
                                                                @if($character->vulnerabilities && count($character->vulnerabilities) > 0)
                                                                    <div class="flex items-center gap-1">
                                                                        ...
                                                                        @foreach($character->vulnerabilities as $vul)
                                                                            <span class="px-1.5 py-0.5 bg-red-900/30 text-red-300 rounded text-[10px] border border-red-800/50">
                                                                                {{ ucfirst($vul) }}
                                                                            </span>
                                                                        @endforeach
                                                                    </div>
