...
@section('content')
    <div class="max-w-2xl mx-auto">
        ...
        <form action="{{ route('characters.conditions.store', $character) }}" method="POST"
            ...
            <div id="custom-name-field" style="display: none;">
                ...
                <input type="text" name="custom_name" id="custom_name" value="{{ old('custom_name') }}"
                    class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 text-white">
                @error('custom_name')
                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="number" name="duration_rounds" id="duration_rounds" value="{{ old('duration_rounds') }}"
                    class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 text-white"
                    min="1">
            ...
            <div class="flex space-x-4">
                ...
                <a href="{{ route('combats.show', $character->combat) }}"
