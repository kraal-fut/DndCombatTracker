...
<div class="max-w-2xl mx-auto">
    ...
    <form action="{{ route('combats.characters.store', $combat) }}" method="POST" class="bg-gray-800 rounded-lg p-6 shadow-lg space-y-4">
        @csrf
        ...
        <div class="flex space-x-4">
            ...
            <a href="{{ route('combats.show', $combat) }}" class="bg-gray-700 hover:bg-gray-600 text-white px-6 py-2 rounded-md font-medium transition">
                Cancel
            </a>
        </div>
    </form>
